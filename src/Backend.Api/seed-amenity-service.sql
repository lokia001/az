...
-- Run this script directly against your SQLite database using: sqlite3 app_development.db < seed-amenity-service.sql

-- Check if tables exist
BEGIN TRANSACTION;

-- Delete existing data if needed (optional, comment out if you want to keep existing data)
DELETE FROM "space_booking"."SpaceSystemAmenities" WHERE 1=1;
DELETE FROM "space_booking"."SpaceSystemSpaceServices" WHERE 1=1;
DELETE FROM "space_booking"."SystemAmenities" WHERE 1=1;
DELETE FROM "space_booking"."SystemSpaceServices" WHERE 1=1;

-- Insert SystemAmenity data
INSERT INTO "space_booking"."SystemAmenities" ("Id", "Name", "Description", "IconUrl")
VALUES
...
INSERT INTO "space_booking"."SystemSpaceServices" ("Id", "Name", "Description")
VALUES
