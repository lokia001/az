...
namespace Backend.Api.Migrations
{
    ...
    [Migration("20250703042950_AddPrivateServicesAndBookingServices")]
    partial class AddPrivateServicesAndBookingServices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Api.Modules.SpaceBooking.Domain.Entities.BookingService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("PrivateServiceId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PrivateServiceId");

                    b.ToTable("BookingServices");
                });

            modelBuilder.Entity("Backend.Api.Modules.SpaceBooking.Domain.Entities.PrivateService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Backend.Api.Modules.SpaceBooking.Domain.Entities.BookingService", b =>
                {
                    b.HasOne("Backend.Api.Modules.SpaceBooking.Domain.Entities.Booking", "Booking")
                        .WithMany("BookingServices")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Api.Modules.SpaceBooking.Domain.Entities.PrivateService", "PrivateService")
                        .WithMany("BookingServices")
                        .HasForeignKey("PrivateServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
